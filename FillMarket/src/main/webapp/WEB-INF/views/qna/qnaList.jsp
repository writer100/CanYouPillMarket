							...
							<div id="panelsStayOpen-collapseOne"
								...
								<div class="accordion-body fs-6">
									<p>A. ①단순 변심 반품 - 상품 수령 후 7일 이내에 사용하지않은 제품에 한하여 가능하며, 상품이
										당사에 도착한 후 2~3일내 검품을 마친 뒤에 환불 처리가 가능합니다. - 왕복택배비 5,000원은 고객님
										부담입니다. ② 상품 불량 반품 - 상품 불량을 증명할 수 있는 사진 첨부 필수 - 상품 수령일로부터 7일 이내
										교환/반품이 가능하며, 택배비는 어시크 가 부담합니다. 환불은 반품 완료 후 결제 방법에 따라 5~7일 정도
										소요되는 점 참고 부탁드리며 고객센터(070-1234-1234)로 문의 부탁드립니다.</p>
								</div>
							</div>
						</div>
						<div class="accordion-item w-100 p-2">
